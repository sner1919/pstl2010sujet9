...
# +++++++++++++++++++ Fichiers objets +++++++++++++++++++
$(BINDIR)/%.o : $(SRCDIR)/%.cpp $(SRCDIR)/settings.hpp
	$(PREPROCESS_AND_COMPIL)

$(BINDIR)/tests/%.o : $(SRCDIR)/tests/%.cpp $(SRCDIR)/settings.hpp
	$(PREPROCESS_AND_COMPIL)
...
CalculatorBlasLapackDep = $(SRCDIR)/CalculatorBlasLapack.hpp $(CalculatorNaiveDep) $(IBlasLapackAdapterDep) $(IFullChecksumMatrixDep)
